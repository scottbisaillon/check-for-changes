...
function checkIfChanges(files, glob) {
    return minimatch_1.default.match(files, glob).length > 0;
}
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (result.all.length < 0) {
            ...
            const changed = checkIfChanges(files, config.filesGlob);
...
const expand = __nccwpck_require__(850)
...
var init_git_executor_chain = __esm({
  "src/lib/runners/git-executor-chain.ts"() {
    import_child_process = __nccwpck_require__(129);
    init_git_error();
    init_task();
    init_utils();
